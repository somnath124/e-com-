        ...
        <div class="wolf">
            ...
            <div class="footer-ol">
                ...
                <ul>
                    ...
                    <li><a href="pro.php?cat_id=8">Headsets</a></li><br><br>
                    <li><a href="pro.php?cat_id=9">Smart Watch</a></li><br><br>
                    <li><a href="pro.php?cat_id=10">Laptops</a></li><br><br>
                    <li><a href="pro.php?cat_id=11">Others</a></li><br><br>
                </ul>
            </div>
            <div class="footer-ol">
                <h4>follow us</h4>
