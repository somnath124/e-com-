     ...
     <div class="cuntainer">
        <div class="wolf">
            ...
            <div class="footer-ol">
                <h4>online shop</h4>
                <ul>
                    <li><a href="#">Android Products</a></li><br><br>
                    <li><a href="#">Headset Prtoducts</a></li><br><br>
                    <li><a href="#">Watches</a></li><br><br>
            ...
            <p class="credit">Copyright &copy; <span>2015-2024</span> | all rights reserved. | <span>Designed With By Your Company Name</span></p>
        </div>
     </div>
  </footer>
