...
<nav class="navbar"> 
     ...
     <ul >
            ...
            <li><a class="active" href="pro.php">SHOP</a></li>
...
<!--Page Session Start-->
            ...
            <ul class="pagination">
              <?php
                ...
                echo "<li> <a  href='pro.php?page=1' >".'First Page'." </a> </li>";
                for($i=1; $i<=$total_pages; $i++){
                   echo "<li> <a href='pro.php?page=".$i."'> ".$i." </a> </li>";
                 };
                 echo "<li> <a href='pro.php?page=$total_pages'>".'Last Page'." </a> </li>";
                }
              } 
                ?>
</ul>
